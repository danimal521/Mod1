    ...
    public static class MansionTemplate extends StructureComponentTemplate
        {
            ...
            protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_, StructureBoundingBox p_186175_5_)
            {
                if (p_186175_1_.startsWith("Chest"))
                {
                    ...
                    this.generateChest(p_186175_3_, p_186175_5_, p_186175_4_, p_186175_2_, LootTableList.CHESTS_WOODLAND_MANSION, iblockstate);
                }
                else if ("Mage".equals(p_186175_1_))
                {
                    ...
                    p_186175_3_.spawnEntity(entityevoker);
    ...
    static class Placer
        {
            ...
            private void createRoof(List<WoodlandMansionPieces.MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, WoodlandMansionPieces.SimpleGrid p_191123_4_, @Nullable WoodlandMansionPieces.SimpleGrid p_191123_5_)
            {
                for (int i = 0; i < p_191123_4_.height; ++i)
                {
                    ...
                    {
                        BlockPos lvt_8_1_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (i - this.startY) * 8);
                        lvt_8_1_ = lvt_8_1_.offset(p_191123_3_.rotate(EnumFacing.EAST), (j - this.startX) * 8);
                        ...
                        {
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.templateManager, "roof", lvt_8_1_.up(3), p_191123_3_));
                ...
                if (p_191123_5_ != null)
                {
                    for (int k = 0; k < p_191123_4_.height; ++k)
                    {
                        ...
                        {
                            BlockPos lvt_8_3_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (k - this.startY) * 8);
                            lvt_8_3_ = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), (i1 - this.startX) * 8);
